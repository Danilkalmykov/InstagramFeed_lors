            ...
            if (options.container != "") {
                ...
                if (options.styling) {
                    ...
                    styles = {
                        ...
                        gallery_image_link: ' style="width:100%; margin:' + options.margin + '%;position:relative; display: inline-block; height: 100%;"'
                    };
                ...
                if (options.display_gallery) {
                    if (typeof data.is_private !== "undefined" && data.is_private === true) {
                        ...
                        for (var i = 0; i < max; i++) {
                            ...
                            html += '<div style="padding: 2px 4px;" class="col-md-2 col-sm-4 col-xs-6"><a href="' + url + '"' + (options.display_captions ? ' data-caption="' + caption + '"' : '') + ' class="instagram-' + type_resource + '" rel="noopener" target="_blank"' + styles.gallery_image_link + '>';
                ...
                if (options.display_igtv && typeof data.edge_felix_video_timeline !== "undefined") {
                    ...
                    if (igtv.length > 0) {
                        ...
                        for (var i = 0; i < max; i++) {
                            ...
                            html += '<div style="padding: 2px 4px;" class="col-md-2 col-sm-4 col-xs-6"><a href="' + url + '"' + (options.display_captions ? ' data-caption="' + caption + '"' : '') + ' rel="noopener" target="_blank"' + styles.gallery_image_link + '>';
